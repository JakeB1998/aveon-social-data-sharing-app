...
public class Friend implements Serializable, Comparable<Friend>, Comparator<Friend> {
    ...
    {
        Log.i(this.getClass().getName(), "This account id : " + friendAccount.getAccountId() +  "That account id : " + friend.getFriendAccount().getAccountId());
        return friendAccount.getAccountId() == friend.getFriendAccount().getAccountId();
    }
