...
public class ServerDatabaseOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "ClientServerInformation.db";

    public ServerDatabaseOpenHelper(Context context) {
